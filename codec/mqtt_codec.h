...
typedef enum len_based_parsing_state_e {PARSING_HEADER, PARSING_PAYLOAD} length_based_parsing_state;
...
typedef struct tmq_len_based_codec_s { LEN_BASED_CODEC_PUBLIC_MEMBERS } tmq_len_based_codec_t;
