...
#define MQTT_CONNECT_PENDING    30 * 1000
#define MQTT_IO_THREAD  4

typedef tmq_map(tmq_tcp_conn_t*, tmq_timer_t*) tcp_conn_pending_list;
...
typedef struct tmq_broker_s
{
    ...
    pthread_mutex_t tcp_conns_lk;
    tcp_conn_pending_list pending_tcp_conns;
